...
public partial class OtpVerificationPage : ContentPage
{
    ...
    {
        set => _fromProfile = bool.TryParse(value, out var parsed) && parsed;
    }
        ...
        try
        {
            ...
            if (_fromProfile)
            {
                await DisplayAlertAsync(
                    "Email Verified",
                    "Your email is verified. BikeMate admin can now review your account details for approval.",
                    "Back to Profile");
