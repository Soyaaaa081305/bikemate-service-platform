...
public partial class AccCreate5 : ContentPage
{
    ...
    private async void OnVerifyClicked(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            await DisplayAlert("Email verified", "Your shop-admin email was verified. BikeMate admin will review the submitted shop details next.", "OK");
        }
        catch (Exception ex)
        {
    ...
    private async void OnResendClicked(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            await DisplayAlert("OTP sent", "BikeMate sent a new verification code to your email. Use the latest code to continue the application review flow.", "OK");
        }
        catch (Exception ex)
        {
