    ...
    IEmailService emailService) : ControllerBase
{
    ...
    public async Task<ActionResult<MechanicApplicationDto>> CreateMechanicApplication(CreateMechanicApplicationDto dto, CancellationToken cancellationToken)
    {
        ...
        await db.SaveChangesAsync(cancellationToken);
        await emailService.SendOtpAsync(user, otpCode, "email_verification", cancellationToken);
    ...
    {
        return new ShopDetailsDto(shop.ShopId, shop.ShopName, shop.ShopDescription, shop.AddressLine, shop.City, shop.Province, shop.ContactNumber, shop.ShopStatus, shop.Latitude, shop.Longitude, shop.ShopImageUrl, shop.ShopLogoUrl);
    }
